...
import restauranteMobile from '../assets/places/restaurant-mobile.jpg';
...
import piqueteaderoMobile from '../assets/places/piqueteadero-mobile.jpg';
...
export const INTERNAL_PLACE: InternalPlace = {
  RESTAURANT: {
    photo: isDesktop ? restaurante : restauranteMobile,
    title: 'RESTAURANTE',
    description:
  ...
  PIQUETEADERO: {
    photo: isDesktop ? piqueteadero : piqueteaderoMobile,
    title: 'PIQUETEADERO',
    description:
  ...
  CAFE: {
    photo: isDesktop ? cafe : cafeMobile,
    title: 'CAFÉ',
    description:
